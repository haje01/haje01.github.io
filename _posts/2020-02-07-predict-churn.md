...
* 일반적으로 Ga 군의 유저는 이탈 확률이 낮고, Gc 군의 유저는 높을 것으로 추정되며 징후도 다를 것이기에 각 군집을 별도로 학습한다.
...
* *기간 접속일 (plays, p_d)* : 주어진 기간 동안 유저가 접속한 일 수
  * 10 일 동안 4번 접속한 경우 $p_{10} = 4$
* *주당 접속일 수 (week_plays, w)* : 주어진 기간 동안 유저의 접속일 수를 주 단위로 계산한 것.
