...
저번에는 수작업된 피처들과 적당히 선택한 초모수로 훈련하였다. 최근에 Featuretools 등의 자동 피처 합성기와 Dask 나 Ray 클러스터를 이용한 초모수 최적화(Hyper-parameter Optimization) 테크닉을 알게되어 활용해보려 한다. 얼마 안되는 피처에서 대충 설정한 초모수 보다는 좋은 결과를 기대한다.
