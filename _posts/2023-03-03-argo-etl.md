...
> `inputs` - `artifacts`, `parameters` ([문서](https://argoproj.github.io/argo-workflows/fields/#inputs))
> `outputs` - `artifacts`, `exitCode`, `parameters`, `result` ([문서](https://argoproj.github.io/argo-workflows/fields/#outputs))
