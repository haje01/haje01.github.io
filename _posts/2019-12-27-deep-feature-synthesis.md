...
사용하여 $\{f (\bar p_i)\}_{i = 1}^N$ 의 

$\{f (\bar p_i)\}_{i = 1}^N$ 의 밀도를 모델링한 다음, 이 밀도의 *cdf*를 추정합니다. 

사용하여 $\{f (\bar p_i)\}_{i = 1}^N$ 의 밀도를 모델링한 다음, 이 밀도의 *cdf*를 추정합니다. 그런 다음 $\{f (\bar p_i)\}_{i = 1}^N$ 의 각 값에 대한 cdf 값을 생성하는데, 
